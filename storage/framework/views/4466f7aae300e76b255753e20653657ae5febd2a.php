                ...
                <div class="mt-6 bg-slate-100 w-1/2 rounded p-6">
                    ...
                    <div class="flex space-x-2 mt-4 p-2">
                        <?php if($permission->roles): ?>
                            <?php $__currentLoopData = $permission->roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission_role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                <form class="px-4 py-2 bg-red-500 hover:bg-red-700 text-white rounded-md" method="POST" action="<?php echo e(route('admin.permissions.roles.remove', [$permission->id, $permission_role->id])); ?>" onsubmit="return confirm('Are you sure?');">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>
                                    <button type="submit"><?php echo e($permission_role->name); ?></button>
                                </form>
                    ...
                    <div class="max-w-xl mt-6">
                        <form method="POST" action="<?php echo e(route('admin.permissions.roles', $permission->id)); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="sm:col-span-6">
...
<?php endif; ?>
<?php /**PATH /Users/Craig/Sites/localhost/spatie.lan/spatie/resources/views/admin/permissions/edit.blade.php ENDPATH**/ ?>