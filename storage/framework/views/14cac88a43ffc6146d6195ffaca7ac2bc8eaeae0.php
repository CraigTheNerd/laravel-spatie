    ...
    <div class="py-12 w-full">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-lg sm:rounded-lg p-2">
                <div class="flex">
                    <a href="<?php echo e(route('admin.roles.index')); ?>" class="px-4 py-2 text-slate-700 text-sm bg-slate-300 hover:bg-slate-400 rounded-md">Role Index</a>
                </div>
...
<?php endif; ?>
<?php /**PATH /Users/Craig/Sites/localhost/spatie.lan/spatie/resources/views/admin/roles/create.blade.php ENDPATH**/ ?>