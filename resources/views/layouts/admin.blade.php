    ...
    <div class="flex-col w-full md:flex md:flex-row md:min-h-screen bg-slate-50">
        <div @click.away="open = false" class="flex flex-col flex-shrink-0 w-full text-gray-700 bg-white md:w-64 dark:text-gray-200 dark:bg-gray-800" x-data="{ open: false }">
            ...
            <nav :class="{'block': open, 'hidden': !open}"
                ...
                <x-admin-link :href="route('dashboard')" :active="request()->routeIs('dashboard')">Dashboard</x-admin-link>
...
{{--            <div class="flex w-full justify-center mx-auto sm:items-center sm:justify-between">--}}
{{--                <main>--}}
{{--                    {{ $slot }}--}}
{{--                </main>--}}
{{--            </div>--}}
